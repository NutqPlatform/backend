...
namespace Nutq.Core.Interfaces
{
    public interface IExerciseProgressService
    {
        ...
        Task CompleteExerciseAsync(int patientId, int planExerciseId, double? score = null, string? sessionData = null);
        Task CompleteRepetitionAsync(int patientId, int planExerciseId, string? sessionData = null);
    }
}
